...
export default function About() {
  return (
    <section id="hakkimda" aria-labelledby="hakkimda-baslik" className="py-20 scroll-mt-24 animate-slide-up">
      ...
      <div className="flex flex-col md:flex-row items-center md:items-start gap-12 bg-white/50 dark:bg-white/[0.02] backdrop-blur-3xl border border-gray-200/50 dark:border-white/5 p-8 sm:p-12 md:p-16 rounded-3xl shadow-sm">
        ...
        <div className="relative flex-shrink-0 group mx-auto md:mx-0">
          ...
          <img
            ...
            className="w-48 h-48 md:w-56 md:h-56 rounded-full object-cover border-4 border-white dark:border-[#121826] shadow-xl relative z-10 transition-transform duration-500 group-hover:scale-[1.02]"
          />
        </div>
        
        <div className="flex flex-col gap-6 flex-1 text-center md:text-left mt-4 md:mt-0">
          <h3 className="text-xl md:text-2xl font-semibold text-gray-900 dark:text-gray-100">
            Kod yazmaktan daha fazlası...
          </h3>
          <p className="text-base md:text-lg leading-relaxed text-gray-600 dark:text-gray-400 font-light">
